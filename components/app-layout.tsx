...
import { LayoutDashboard, PawPrint, User, LogOut, Heart, Plus } from "lucide-react"
          ...
          <ul className="space-y-2">
            ...
            <li>
              <Link
                ...
                className={cn(
                  "flex items-center gap-3 px-4 py-3 rounded-lg transition-colors",
                  pathname === "/profile" ? "bg-primary text-primary-foreground" : "text-foreground hover:bg-muted",
                )}
              >
