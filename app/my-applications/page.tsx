...
export default function MyApplicationsPage() {
  ...
  const handleWithdraw = async (appId: string, petId: string, petName: string) => {
    if (!user) return;
      ...
      <div className="max-w-6xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Manage and track all your submitted pet adoption applications in one convenient view.
          </p>
        </div>
        ...
        {apps.length === 0 ? (
          <div className="text-center py-12 bg-card rounded-lg border">
            ...
            <Button onClick={() => router.push('/matches')}>Send your first application</Button>
          </div>
        ) : (
          <div className="grid gap-4 md:grid-cols-3">
            {apps.map((app) => (
              ...
              >
                ...
                <p className="mt-2 text-sm font-medium capitalize">Status: {app.pet_status}</p>
                ...
                <div className="mt-3 flex gap-2">
                  ...
                  <Button
                    onClick={() => handleWithdraw(app.id, app.pet_id, app.pet_name)}
